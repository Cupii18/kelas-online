...
router.get("/kelas_materi_detail/", auth.isAuth, kelas_materi_detailCTRL.tampil);
router.get("/kelas_materi_detail/:id_kelas_materi_detail", auth.isAuth, kelas_materi_detailCTRL.cari);
